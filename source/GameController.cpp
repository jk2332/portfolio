...
//    if (ticks == 0 && _levelId == "level1" or _levelId == "level2" or _levelId == "level3" or _levelId == "level5" or _levelId == "level6") {
//        CULog("displaying tutorial");
//        _levelworldnode->sortZOrder();
