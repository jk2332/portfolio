...
<<<<<<< HEAD
    ...
    cugl::Vec2 posToGridCoord(cugl::Vec2 p){
        if (!isInBounds(p)){
            ...
            int x = int((p.x - DOWN_LEFT_CORNER_X)/GRID_WIDTH);
            int y = int((p.y - DOWN_LEFT_CORNER_Y)/GRID_HEIGHT);
    ...
    bool isInBounds(cugl::Vec2 p){
        ...
        if (p.x <= DOWN_LEFT_CORNER_X or p.x >= DOWN_LEFT_CORNER_X + GRID_WIDTH*_gridNumX or p.y <= DOWN_LEFT_CORNER_Y or p.y >= DOWN_LEFT_CORNER_Y + GRID_HEIGHT*_gridNumY){
            return false;
        }
        return true;
    }
    ...
    bool isInBounds(float x, float y){
        if (x <= DOWN_LEFT_CORNER_X or x >= DOWN_LEFT_CORNER_X + GRID_WIDTH*_gridNumX or y <= DOWN_LEFT_CORNER_Y or y >= DOWN_LEFT_CORNER_Y + GRID_HEIGHT*_gridNumY){
            return false;
        }
        return true;
    }
