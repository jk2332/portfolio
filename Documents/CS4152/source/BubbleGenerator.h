...
//  control its current position.  However, its main purpose is as a Particle generator
...
//  Version: 1/26/17
//
#ifndef __BUBBLE_GENERATOR_H__
#define __BUBBLE_GENERATOR_H__
...
#pragma mark Particle System
	...
	std::shared_ptr<Node> _generatorNode;
...
#pragma mark Animation Support
	 ...
	 */
	void setGeneratorNode(const std::shared_ptr<cugl::Node>& node) { _generatorNode = node; }
     ...
     */
    std::shared_ptr<cugl::Node> getGeneratorNode() const {
